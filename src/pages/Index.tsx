...
const Index = () => {
	// Function to scroll to the main content/converter section
	...
	const handleViewSource = () => {
		...
		window.open(
			"https://github.com/VashuChaudhary/pdftoimg",
			"_blank",
			"noopener,noreferrer"
		);
	};
	...
	return (
		<div className="min-h-screen bg-gradient-primary">
						...
						<div className="space-y-8">
							<div className="space-y-4">
								...
								<p className="text-lg text-purple-100 max-w-lg">
									Transform your documents instantly. Convert PDFs to images or
									combine multiple images into a single PDF - all processed
			...
			{/* Main Content */}
			<div id="converter-section" className="relative bg-background">
				...
				<div className="relative container mx-auto px-4 py-16">
					<div className="text-center mb-12">
						...
						<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
							Select the tool you need to transform your documents. All
							processing happens locally in your browser for maximum security
							and privacy.
						</p>
					</div>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="text-center space-y-4">
							...
							<p className="text-muted-foreground text-sm">
								Advanced algorithms ensure your converted files maintain their
								quality.
							</p>
						</div>
					</div>
